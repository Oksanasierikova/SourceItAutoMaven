...
public class L1HW1 {
    ...
    public static void test1() {
        ...
        driver1.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);//implicit wait
//        driver1.findElement(By.cssSelector(".rz-header-search-input-text"))
//                .sendKeys("Iphone");
        driver1.findElement(By.xpath("//input[@class='rz-header-search-input-text passive']")
        ).sendKeys("Iphone");
        ...
        assert result.equals("Apple");//проверка что результат равен apple
